...
function VRA:CreateBar(player,spell)
	if(vradb.spells[tostring(spell)]~=nil) then
	if(vradb.spells[tostring(spell)].enable) then
	if(not locked) then
		local name, rank, icon, cost, isFunnel, powerType, castTime, minRange, maxRange = GetSpellInfo(spell)
					...
					spellCastSuccess = {
						...
						args = {
							general = {
								...
								name = L["General Abilities"],
								order = 4,
								args = listOption({178207},"castSuccess"),
							},
							dk	= {
								type = 'group',
								inline = true,
								name = L["|cffC41F3BDeath Knight|r"],
								order = 5,
								args = listOption({51052,61999,108199},"castSuccess"),
							},
							dh	= {
								type = 'group',
								inline = true,
								name = L["|cffA330C9Demon Hunter|r"],
								order = 6,
								args = listOption({196718,179057,202137,207684,202138},"castSuccess"),
							},
							druid = {
								type = 'group',
								inline = true,
								name = L["|cffFF7D0ADruid|r"],
								order = 7,
								args = listOption({740,106898,77764,77761,20484,197721,102793},"castSuccess"),
							},
							hunter = {
								type = 'group',
								inline = true,
								name = L["|cffABD473Hunter|r"],
								order = 8,
								args = listOption({264667,109248},"castSuccess"),
							},
							mage = {
								type = 'group',
								inline = true,
							...
							monk = {
								...
								name = L["|cFF558A84Monk|r"],
								order = 10,
								args = listOption({115310,119381,116844},"castSuccess"),
							},
							paladin = {
								type = 'group',
								inline = true,
							...
							preist	= {
								...
								name = L["|cffFFFFFFPriest|r"],
								order = 12,
								args = listOption({200183,64843,62618,271466,32375,15286,64901,205369,265202,73325,34433,246287,47536},"castSuccess"),
							},
							rogue = {
								type = 'group',
								inline = true,
							...
							shaman	= {
								...
								name = L["|cff0070daShaman|r"],
								order = 14,
								args = listOption({2825,32182,108280,98008,192077,198838,192058,207399,8143},"castSuccess"),
							},
							warlock = {
								type = 'group',
								inline = true,
