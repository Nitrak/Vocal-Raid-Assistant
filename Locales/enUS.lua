...
L["Config Cleaning Error Message"] = "Vocal Raid Assistant:\nError cleaning Config, please close WoW then delete VocalRaidAssistant.lua and VocalRaidAssistant.lua.bak in WoWFolder\\WTF\\Account\\<ACCOUNTNAME>\\SavedVariables"